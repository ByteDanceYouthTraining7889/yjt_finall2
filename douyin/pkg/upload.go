...
const TypeVedio FlieType = 10 //再次使用时 自动+1
...
func CheckContainExit(t FlieType, name string) bool { //检查文件后缀是否包含在约定的配置中
	ext := GetFileExt(name)
...
func CheckMaxSize(t FlieType, f multipart.File) bool { //检查文件大小是否对
